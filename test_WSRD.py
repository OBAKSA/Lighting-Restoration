...
from torch.utils.data import DataLoader
from data_WSRD import ImageDataset_WSRD
...
def main():
    ...
    parser.add_argument('--eval_path', type=str, default='./datasets/WSRD/',
    ...
    # Dataset & Dataloader
    test_dataset = ImageDataset_WSRD(image_dirs=opt.eval_path)
