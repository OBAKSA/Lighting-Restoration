...
from torch.utils.data import DataLoader
from data_CL3AN import ImageDataset_CL3AN

from model_DINOLight_amp import DINOLight_amp
...
def main():
    ...
    parser.add_argument('--eval_path', type=str, default='./datasets/CL3AN/',
    ...
    # Dataset & Dataloader
    test_dataset = ImageDataset_CL3AN(image_dirs=opt.eval_path)
    ...
    with torch.no_grad():
        ...
        if opt.exp_name == 'dinolight':
            network = DINOLight_amp(channels=32).cuda()
